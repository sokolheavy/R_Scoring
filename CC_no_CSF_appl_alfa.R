...
names(work_data)
i<-43
work_data<-work_data[complete.cases(work_data[,i]),]
print(names(work_data[i]))
print(table(work_data[i], useNA = "always"))
...
work_data$Way_of_purchase_of_habitation <- NULL

work_data[is.na(work_data$Add_Income_from_UW), ]
names(work_data)
work_data[is.na(work_data$Add_Income_from_UW), 61] <- 0
work_data[is.na(work_data$Add_Income_from_UW), ]

work_data[is.na(work_data$Payments_in_banks_from_client), ]
names(work_data)
work_data[is.na(work_data$Payments_in_banks_from_client), 65] <- 0
work_data[is.na(work_data$Payments_in_banks_from_client), ]

work_data[is.na(work_data$Payments_in_banks_UW), ]
work_data[is.na(work_data$Payments_in_banks_total), ]
names(work_data)
work_data[is.na(work_data$Payments_in_banks_total), 67] <- 0
work_data[is.na(work_data$Payments_in_banks_total), ]

work_data[is.na(work_data$Payments_in_alfa), ]
names(work_data)
work_data[is.na(work_data$Payments_in_alfa), 68] <- 0
work_data[is.na(work_data$Payments_in_alfa), ]
...
work_data[is.na(work_data$di), ]
names(work_data)
work_data<-work_data[complete.cases(work_data[,69]),]
...
work_data[is.na(work_data$dti_clear), ]

work_data[is.na(work_data$sum_amountbegin_close_loans), ]

work_data[is.na(work_data$Sum_cur_out), ]

work_data[is.na(work_data$Max_dpd_ever), ]
names(work_data)
work_data<-work_data[complete.cases(work_data[,142]),]
table(work_data$Max_dpd_ever)
...
variable_fc <- 35 #put number of first variable column
...
bin_data$dti_cat_sb <- NULL

bin_data$di_cat_eq <- NULL
...
bin_data$Main_Income_from_client_cat_sb <- NULL
...
bin_data$Payments_in_alfa_cat_sb<-NULL

bin_data$count_all_loans_cat_eq<- NULL
bin_data$count_all_loans_cat_km<- NULL

bin_data$count_close_loans_cat_eq<- NULL
bin_data$count_close_loans_cat_km<- NULL

bin_data$count_Pil_loans_close_cat_km<- NULL
bin_data$count_CSF_loans_close_cat_km<- NULL
bin_data$count_CSF_loans_close_cat_eq<- NULL

bin_data$count_CSF_loans_close_cat_sb<- NULL

bin_data$sum_amountbegin_all_loans_cat_eq <- NULL
bin_data$sum_amountbegin_all_loans_cat_km <- NULL
bin_data$sum_amountbegin_all_loans_CC_cat_km <- NULL
bin_data$sum_amountbegin_all_loans_CC_cat_eq <- NULL
bin_data$sum_amountbegin_all_loans_PIL_cat_eq <- NULL
bin_data$sum_amountbegin_all_loans_PIL_cat_km <- NULL
bin_data$sum_amountbegin_all_loans_CSF_cat_eq <- NULL

bin_data$sum_amountbegin_open_loans_cat_eq <- NULL
bin_data$sum_amountbegin_open_loans_cat_km <- NULL
bin_data$sum_amountbegin_open_loans_CC_cat_eq <- NULL
bin_data$sum_amountbegin_open_loans_CC_cat_km <- NULL
bin_data$sum_amountbegin_close_loans_cat_eq <- NULL
bin_data$sum_amountbegin_close_loans_cat_km <- NULL
bin_data$sum_amountbegin_close_loans_CC_cat_km <- NULL
bin_data$sum_amountbegin_close_loans_PIL_cat_km <- NULL
bin_data$sum_amountbegin_close_loans_CSF_cat_eq <- NULL
bin_data$sum_amountbegin_close_loans_CSF_cat_km <- NULL

bin_data$sum_amountmax_all_loans_cat_km <- NULL
bin_data$sum_amountmax_all_loans_CC_cat_eq <- NULL
bin_data$sum_amountmax_all_loans_CC_cat_km <- NULL
bin_data$sum_amountmax_all_loans_PIL_cat_eq <- NULL
bin_data$sum_amountmax_all_loans_PIL_cat_km <- NULL
bin_data$sum_amountmax_all_loans_CSF_cat_eq <- NULL
bin_data$sum_amountmax_all_loans_CSF_cat_sb <- NULL
bin_data$sum_amountmax_open_loans_cat_eq <- NULL
bin_data$sum_amountmax_open_loans_cat_km <- NULL
bin_data$sum_amountmax_open_loans_CC_cat_eq <- NULL
bin_data$sum_amountmax_open_loans_CC_cat_km <- NULL
bin_data$sum_amountmax_close_loans_cat_eq <- NULL
bin_data$sum_amountmax_close_loans_cat_km <- NULL
bin_data$sum_amountmax_close_loans_PIL_cat_km <- NULL
bin_data$sum_amountmax_close_loans_CSF_cat_eq <- NULL
bin_data$sum_amountmax_close_loans_CSF_cat_km <- NULL

bin_data$max_amountbegin_all_loans_cat_eq <- NULL
bin_data$max_amountbegin_all_loans_cat_km <- NULL
bin_data$max_amountbegin_all_loans_CC_cat_eq <- NULL
bin_data$max_amountbegin_all_loans_CC_cat_km <- NULL
bin_data$max_amountbegin_all_loans_PIL_cat_eq <- NULL
bin_data$max_amountbegin_all_loans_PIL_cat_km <- NULL
bin_data$max_amountbegin_all_loans_CSF_cat_km <- NULL
bin_data$max_amountbegin_open_loans_cat_eq <- NULL
bin_data$max_amountbegin_open_loans_cat_km <- NULL
bin_data$max_amountbegin_open_loans_CC_cat_eq <- NULL
bin_data$max_amountbegin_open_loans_CC_cat_km <- NULL
bin_data$max_amountbegin_close_loans_cat_eq <- NULL
bin_data$max_amountbegin_close_loans_cat_km <- NULL
bin_data$max_amountbegin_close_loans_CC_cat_km <- NULL
bin_data$max_amountbegin_close_loans_PIL_cat_km <- NULL
bin_data$max_amountbegin_close_loans_CSF_cat_eq <- NULL
bin_data$max_amountbegin_close_loans_CSF_cat_km <- NULL

bin_data$max_amountmax_all_loans_cat_eq <- NULL
bin_data$max_amountmax_all_loans_cat_km <- NULL
bin_data$max_amountmax_all_loans_CC_cat_eq <- NULL
bin_data$max_amountmax_all_loans_CC_cat_km <- NULL
bin_data$max_amountmax_all_loans_PIL_cat_eq <- NULL
bin_data$max_amountmax_all_loans_PIL_cat_km <- NULL
bin_data$max_amountmax_all_loans_CSF_cat_sb <- NULL
bin_data$max_amountmax_open_loans_cat_km <- NULL
bin_data$max_amountmax_open_loans_cat_sb <- NULL
bin_data$max_amountmax_open_loans_CC_cat_eq <- NULL
bin_data$max_amountmax_open_loans_CC_cat_km <- NULL
bin_data$max_amountmax_close_loans_cat_eq <- NULL
bin_data$max_amountmax_close_loans_cat_km <- NULL
bin_data$max_amountmax_close_loans_PIL_cat_km <- NULL
bin_data$max_amountmax_close_loans_CSF_cat_eq <- NULL
bin_data$max_amountmax_close_loans_CSF_cat_km <- NULL

bin_data$out_to_amountbegin_cat_sb <- NULL
bin_data$out_to_amountmax_cat_eq <- NULL
bin_data$out_to_amountmax_cat_sb <- NULL

bin_data$Sum_cur_out_cat_km <- NULL
bin_data$Sum_cur_out_cat_sb <- NULL

bin_data$Sum_cur_out_CC_cat_eq <- NULL
bin_data$Sum_cur_out_CC_cat_km <- NULL
...
bin_data$From_first_to_last_loan_monthes_cat_eq <- NULL
...
bin_data$Missed_payment_ever_ever_cat_eq <- NULL
bin_data$Missed_payment_ever_ever_cat_km <- NULL
...
bin_data$Missed_payment_ever_proc_cat_km <- NULL
...
bin_data$max_dpd_then_pay_all_payment_3m_cat_km <- NULL
...
bin_data$Month_since_del_more_then_30_cat_sb <- NULL
...
bin_data$Missed_payment_ever_ever_cat_sb <- NULL
bin_data$Payments_in_alfa_cat_eq <- NULL
bin_data$sum_amountmax_open_loans_CC_cat_sb <- NULL
bin_data$sum_amountbegin_open_loans_CC_cat_sb <- NULL

bin_ncol <- ncol(bin_data)

#change variables categories

table(bin_data$Max_dpd_6m_cat_eq, useNA = "always")

levels(bin_data$sum_amountmax_all_loans_cat_sb)[levels(bin_data$sum_amountmax_all_loans_cat_sb) == "(319;2400]"] <- "(319;5000]"
levels(bin_data$sum_amountmax_all_loans_cat_sb)[levels(bin_data$sum_amountmax_all_loans_cat_sb) == "(2400;4200]"] <- "(319;5000]"
levels(bin_data$sum_amountmax_all_loans_cat_sb)[levels(bin_data$sum_amountmax_all_loans_cat_sb) == "(4200;5000]"] <- "(319;5000]"
...
levels(bin_data$Relationship_with_contact_person)[levels(bin_data$Relationship_with_contact_person) == "WIFE"] <- "HUSBAND"
...
bin_data$Total_work_experience_in_years_cat_sb<-NULL
...
bin_data$Payments_in_banks_UW_cat_sb <-NULL

bin_ncol <- ncol(bin_data)

#remove high correlation

bin_data$count_Pil_loans_cat_sb <- NULL
bin_data$sum_amountbegin_close_loans_CC_cat_sb <- NULL
bin_data$max_amountmax_all_loans_CSF_cat_km <- NULL
bin_data$max_amountbegin_all_loans_CSF_cat_sb <- NULL
bin_data$sum_amountmax_all_loans_CSF_cat_km <- NULL
bin_data$sum_amountmax_all_loans_PIL_cat_sb <- NULL
bin_data$sum_amountbegin_all_loans_PIL_cat_sb <- NULL
bin_data$max_amountmax_all_loans_PIL_cat_sb <- NULL
bin_data$sum_amountbegin_all_loans_CSF_cat_km <- NULL
bin_data$max_amountmax_close_loans_CSF_cat_sb <- NULL
bin_data$max_amountbegin_all_loans_PIL_cat_sb <- NULL
bin_data$sum_amountmax_close_loans_PIL_cat_sb <- NULL
bin_data$sum_amountbegin_close_loans_PIL_cat_sb <- NULL
bin_data$max_amountmax_close_loans_PIL_cat_sb <- NULL
bin_data$max_amountbegin_close_loans_CSF_cat_sb <- NULL
bin_data$sum_amountmax_close_loans_CSF_cat_sb <- NULL
bin_data$max_dpd_then_pay_all_payment_1m_cat_sb <- NULL
bin_data$Missed_payment_ever_1m_cat_eq <- NULL
bin_data$Sum_cur_out_CC_cat_sb <- NULL
bin_data$sum_amountbegin_close_loans_cat_sb <- NULL
bin_data$max_amountmax_close_loans_cat_sb <- NULL
...
bin_data$Missed_payment_ever_proc_cat_sb <- NULL
bin_data$max_amountmax_open_loans_CC_cat_sb <- NULL
bin_data$sum_amountmax_all_loans_CC_cat_sb <- NULL
...
bin_data$Type_of_organization <- NULL
bin_data$sum_amountmax_open_loans_cat_sb <- NULL
bin_data$sum_amountmax_close_loans_cat_sb <- NULL
bin_data$max_dpd_then_pay_all_payment_6m_cat_eq <- NULL
bin_data$max_amountbegin_open_loans_CC_cat_sb <- NULL
bin_data$sum_amountbegin_all_loans_CC_cat_sb <- NULL
bin_data$max_dpd_then_pay_all_payment_ever_cat_sb <- NULL
bin_data$Total_work_experience_in_months_cat_sb <- NULL
bin_data$max_dpd_then_pay_all_payment_3m_cat_sb <- NULL
bin_data$sum_amountmax_all_loans_cat_eq <- NULL
bin_data$Missed_payment_3m_proc_cat_sb <- NULL
...
bin_data$From_first_to_last_loan_monthes_cat_sb<- NULL
...
pdf("CorrPlot_3.pdf",width = 25,height=25,paper='special')
...
groupvars[[2]]  <- groupvars[[1]][-50]
groupvars[[2]]  <- groupvars[[2]][-48]
groupvars[[3]]  <- groupvars[[2]][-3] 
groupvars[[4]]  <- groupvars[[2]][-6] 
groupvars[[5]]  <- groupvars[[4]][-43] 
groupvars[[6]]  <- groupvars[[5]][-5] 
groupvars[[7]]  <- groupvars[[5]][-4] 
groupvars[[8]]  <- groupvars[[6]][-5] 
groupvars[[9]]  <- groupvars[[8]][-46] 
groupvars[[10]]  <- groupvars[[9]][-19]
groupvars[[11]]  <- groupvars[[10]][-32] 
groupvars[[12]]  <- groupvars[[10]][-33]
groupvars[[13]]  <- groupvars[[12]][-39]
groupvars[[14]]  <- groupvars[[13]][-42]
groupvars[[14]]  <- groupvars[[14]][-34]
groupvars[[14]]  <- groupvars[[14]][-11]
groupvars[[15]]  <- groupvars[[14]][-19]
groupvars[[15]]  <- groupvars[[15]][-4]
groupvars[[16]]  <- groupvars[[15]][-13]
groupvars[[16]]  <- groupvars[[16]][-5]
groupvars[[17]]  <- groupvars[[16]][-15]
groupvars[[18]]  <- groupvars[[17]][-36]
groupvars[[18]]  <- groupvars[[18]][-18]
groupvars[[19]]  <- groupvars[[18]][-12]
groupvars[[20]]  <- groupvars[[19]][-11]
groupvars[[21]]  <- groupvars[[20]][-33]
groupvars[[22]]  <- groupvars[[21]][-11]
groupvars[[23]]  <- groupvars[[22]][-12]
groupvars[[24]]  <- groupvars[[23]][-1]
groupvars[[25]]  <- groupvars[[24]][-24]
groupvars[[26]]  <- groupvars[[25]][-17]
groupvars[[27]]  <- groupvars[[26]][-19]
groupvars[[28]]  <- groupvars[[27]][-19]
groupvars[[29]]  <- groupvars[[28]][-2]
groupvars[[30]]  <- groupvars[[29]][-22]
groupvars[[31]]  <- groupvars[[30]][-24]
groupvars[[32]]  <- groupvars[[31]][-5]
groupvars[[33]]  <- groupvars[[32]][-14]
groupvars[[34]]  <- groupvars[[33]][-3]
groupvars[[35]]  <- groupvars[[34]][-16]
groupvars[[36]]  <- groupvars[[35]][-4]
groupvars[[37]]  <- groupvars[[36]][-4]
groupvars[[38]]  <- groupvars[[37]][-14]
groupvars[[39]]  <- groupvars[[38]][-9]
groupvars[[40]]  <- groupvars[[39]][-8]
groupvars[[41]]  <- groupvars[[40]][-14]
groupvars[[42]]  <- groupvars[[41]][-11]
groupvars[[43]]  <- groupvars[[42]][-8]


model_num <- length(groupvars) 

sink('Model_result_1_2.txt')

for (i in (model_num:31))
  {
  t_gv<-groupvars[[i]]
...
# select onle 'WOE' columns
data_cor <- select(data_woe, grep("WOE", names(data_woe))) 
data_cor <- select(data_cor, names(data_cor)[(names(data_cor) %in% groupvars[[length(groupvars)]])])

# calc Correlation
cor_table <- cor( data_cor[!is.infinite(rowSums(data_cor)),])

#build Correlation plot in pdf
pdf("CorrPlot_4.pdf",width = 25,height=25,paper='special')
...
#Models generation part 1

groupvars_1 = list()
groupvars_1[[1]]  <- groupvars[[length(groupvars)]]

model_num <- length(groupvars_1[[1]])

sink('Model_result_2.txt')

for (i in (model_num:1))
{
  t_gv<-groupvars_1[[1]][-i]
  # This returns the model:
  model <- glm(as.formula(paste(measurevar,paste(t_gv, collapse=" + "), sep=" ~ ")), data_log_regr, family = "binomial") 
...
#Models generation part 2

groupvars_2 = list()
groupvars_2[[1]]  <- groupvars[[1]]

model_num_init <- length(groupvars)
model_num <- length(groupvars_2[[1]])
gini_init <-0
deleted_par<-0
...
sink('Model_result_3_2.txt')

for (j in (model_num_init:(model_num_init+length(groupvars_2[[1]])-1)))
{
  for (i in (model_num:1))
  {
    t_gv<-groupvars_2[[length(groupvars_2)]][-i]
    # This returns the model:
    model <- glm(as.formula(paste(measurevar,paste(t_gv, collapse=" + "), sep=" ~ ")), data_log_regr, family = "binomial") 
  ...
  groupvars_2[[length(groupvars_2)+1]]  <- groupvars_2[[length(groupvars_2)]][-deleted_par]
  
  t_gv<-groupvars_2[[length(groupvars_2)]]
  # This returns the model:
  model <- glm(as.formula(paste(measurevar,paste(t_gv, collapse=" + "), sep=" ~ ")), data_log_regr, family = "binomial") 
  
  print(paste("Model", j+1))
  print("")
  print(paste("deleted: ",groupvars_2[[length(groupvars_2)-1]][deleted_par]))
  print("")
  #add column with predicted values
  colname <- paste('target_predict_model_', i, sep = '')
  data_log_regr[[colname]] <- predict(object = model, type = "response")
  ...
  gini_init <-0
  deleted_par<-0
  model_num <- length(groupvars_2[[length(groupvars_2)]])
}
